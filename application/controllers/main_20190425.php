...
//        die;
        ...
        if (!empty($quiz['category'])) {
            ...
            $filter[0]['value'] = $quiz_id;
            $filter[1]['id'] = "category";
            $filter[1]['value'] = $quiz['category'][$i]['category_id'];
            $req_field = array("id");
            $questions_id = $this->main_model->get_many_records("questions", $filter, $req_field);
            $i++;
        }
//        echo '<pre>';
...
//        die;
        ...
        $filter[1]['value'] = $user_id;
        $req_field = array("id");
        $quiz_result_id = $this->main_model->get_many_records("quiz_result", $filter, $req_field);

        $filter2[0]['id'] = "quiz_result_id";
        $filter2[0]['value'] = $quiz_result_id[0]['id'];
        $req = array("*");
        $quiz['quiz_result'] = $this->main_model->get_many_records("quiz_result_answers", $filter2, $req);
