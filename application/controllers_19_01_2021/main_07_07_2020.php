...
//        die;
    ...
    public function custom_node_assignment_to_package($node,$package) {
        $req = array();
        $data = array();
        $parent = array();
        // $package = 4;
