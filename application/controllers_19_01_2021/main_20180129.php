...
class main extends CI_Controller {
    ...
    public function __construct() {
        ...
        $exempted_controllers = array('show_sections', 'index', 'signin', 'change_password', 'do_password_change', 'login_handler', 'logout', 'set', 'update', 'set_many', 'ajax_feeder', 'ajax_fetch', 'loadGrid', 'saveImage', 'submit', 'add_request', 'node', 'score', 'subscribNewsLetter', 'registrationMail', 'register', 'value_action', 'get_records_group_by', 'manage', 'showsheet', 'edit', 'delete', 'set_comments', 'get_comments', 'set_like', 'set_dislike', 'like_counts', 'add', 'quiz', 'create', 'set_data', 'manage_sheet_values', 'sheets', 'testing_view', 'remove');
