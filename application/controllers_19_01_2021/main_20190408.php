...
class main extends CI_Controller {
    ...
    public function __construct() {
        ...
        $exempted_controllers = array('category', 'mailUnSubscribed', 'mailSubscribed', 'checkout', 'blogComment', 'SaveBlogComment', 'blogDetail', 'blogList', 'show_sections', 'signin', 'change_password', 'do_password_change', 'logout', 'set_many', 'ajax_feeder', 'ajax_fetch', 'loadGrid', 'saveImage', 'submit', 'add_request', 'score', 'subscribNewsLetter', 'registrationMail', 'register', 'value_action', 'showsheet', 'edit', 'delete', 'set_comments', 'get_comments', 'set_like', 'set_dislike', 'like_counts', 'add', 'create', 'set_data', 'manage_sheet_values', 'testing_view', 'skill_talk_slider', 'slider', 'skill-talk-slider', 'assessment-center-slider', 'employability-zone-slider', 'about-us', 'contact-us', 'privacy-policy', 'terms-of-use', 'our-values', 'news-letter', 'our-benefits', 'add_excel_user', 'upload_application', 'execl_upload', 'is_validate_application', 'home_sheets', 'set_data_home', 'sana-for-school', 'sana-for-higher', 'sana-for-professionals', 'learning-objectives-school', 'program-benefits-school', 'course-content-school', 'learning-objectives-higher', 'program-benefits-higher', 'course-content-higher', 'learning-objectives-professional', 'program-benefits-professional', 'course-content-professional', 'blog', 'blog-detail', 'my-cart', 'blog_main', 'datetime', 'blog_nav', 'add_blog', 'add_cart', 'my_cart', 'remove_cart');
