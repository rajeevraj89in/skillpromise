            ...
            foreach ($child_data as $child_data_value) {
                ...
                switch ($node_type) {
                    ...
                    case "Sheet":
                        ...
                        $module.='<li><a href = "' . base_url() . 'sheets/sheets/' . $sheet_id . '>' . $child_data_value['name'] . '</a></li>';
                        break;
                    case "Quiz":
                        $quiz_details = $CI_Model->main_model->get_records_from_id('quiz', $id, 'node', array('id', 'quiz_type'));
                        $quiz_type = $quiz_details['quiz_type'];
                        $quiz_id = $quiz_details['id'];
