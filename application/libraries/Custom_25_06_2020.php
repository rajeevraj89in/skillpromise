...
//============================Checking if quiz is empty or not=======================
            ...
            foreach ($nodes as $rec) {
                ...
                switch ($node_type) {
                    ...
                    case "Module":
                        $module .= '<a class="prog-block" href="' . base_url() . 'node/' . $nav_type . '/'.$rec->id . '"><img class="img-responsive" src="'.base_url().'assets/img/icons/'.$rec->image_file.'"><span>' . $rec->name . '</span></a>';
                //$module .= $this->is_child_exist($node_type, $rec->id, $nav_type);
                        //$module .= '<a href = "' . base_url() . "node/$nav_type/$rec->id" . '">' . "$rec->name";
                        //$module .= $this->is_child_exist($node_type, $rec->id, $nav_type);
                        //$module .= "</a>";
                        $module_count++;
                        break;
