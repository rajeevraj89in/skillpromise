...
<section class="col-md-9">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action=" <?php echo base_url() . 'set_data/descriptive_type'; ?>" method="POST">
                ...
                <div class="form-group">
                    <div class="col-lg-12">
                        <hr>
                        <div class="row">
                            <label class="col-sm-3 control-label" for="addEnclosures">Add Answer Header Text</label>
                        ...
                        <div class="row col-lg-8 form-group" id="enclosures_container">
                            <div class="enclo_row well" id="enclo_row" style="display: none;">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <input type="text" placeholder="Answer Header Text" class="form-control answer_header_text">
                                    </div>
                                    <div class="col-lg-6">
