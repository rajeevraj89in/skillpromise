            ...
            <form method="post" class="form-horizontal" role="form" autocomplete="off" id="mainForm" action="<?php echo base_url(); ?>set/questions">
                ...
                <div class="form-group">
                    <div class="form-inline">
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="no_of_options" readonly="readonly" class="form-control" id="no_of_options" placeholder="No. Of Options" min="2" max="25" value ="4">
                        </div>
                    </div>
                    ...
                    <div class="form-inline">
                        ...
                        <div class="col-sm-3">
                            <input type="number" name="question_weight" class="form-control" id="maxMarks" placeholder="Maximum Marks" min="1" max="100" value ="1">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-inline">
                        ...
                        <div class="col-sm-3">
                            <label class="radio-inline ">
                                <input type="radio" name="select_type" id="singleSelect" value="Single" checked> Single
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="select_type" id="multipleSelect" value="Multiple"> Multiple
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-inline">
                        ...
                        <div class="col-sm-3  weighted_option_element">
                            <label class="checkbox-inline">
                                <input name="is_weighted" type="checkbox" id="ifWeighted" value="1"> Enable
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 option_div" id="option_div0" style="display:none">
                        ...
                        <div class="well col-sm-9">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="" class="skill_editor_2"></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="correctBox">Correct Answer</label>
                                <div class="col-sm-3">
                                    <label class="checkbox-inline">
                                ...
                                <div class="col-sm-3 weight_elements">
                                    <input type="number" class="form-control weight_text weight_box" id="weight-0" placeholder="Option Weight" min="0" max="1" value="0">
                                </div>
                            </div>
...
//        $(e).attr('value', e.checked ? 1 : 0);//setting value of check box
    ...
    $(document).ready(function () {//form validation
        $("#mainForm").submit(function () {
            ...
            for (i = 1; i <= options; i++) {
                var optiontext = 1;
                var tempSelector = '#option_div' + options + ' .note-editable';
                optiontext = $(tempSelector).text();
                if (!(optiontext)) {
                    validate = false;
                    errorMessage = errorMessage + "Enter option Text for option " + i + "\n";
                }
            }
            if (!validate) {
                alert(errorMessage);
