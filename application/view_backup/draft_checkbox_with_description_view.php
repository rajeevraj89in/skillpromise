                ...
                <table class="table table-bordered" id="">
                    ...
                    foreach ($data[$category['category']] as $rec) {
                        ...
                        if ($ch) {
                            ...
                            echo '<td><input data-content="' . $rec['description'] . '" type="checkbox" checked class="check" data-category="' . $category['category'] . '" id="' . $rec['id'] . '" name="sheetvalue_id[' . $rec['id'] . ']" value="' . $prev_content . '">'
