        ...
        <div class="col-md-12">
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo base_url() . 'set_data/save_data_checkbox_with_no_tooltip'; ?>" method="POST">
                ...
                foreach ($category_id as $category) {
                    ...
                    <div class="panel-body"><p>' . $this->main_model->get_name_from_id('actionsheet_category', 'description', $category['category']) . '</p></div>
                ...
                <table class="table table-bordered" id="">
                    ...
                    foreach ($data[$category['category']] as $rec) {
                        ...
                        //----
                        if ($ch) {
                            echo '<td><input data-content="' . $rec['description'] . '" type="checkbox" class="check" checked data-category="' . $category['category'] . '" id="' . $rec['id'] . '" name="sheetvalue_id[' . $rec['id'] . ']" value="' . $prev_content . '">'
                            . '<span> '
                            . $rec['name'] . '</span></td>';
                        } else {
