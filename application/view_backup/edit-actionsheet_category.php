...
<section class="col-md-9">
    <h1 class="page-header">Edit Action Sheet Category</h1>
            ...
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action=" <?php echo base_url() . 'set/actionsheet_category'; ?>" method="POST">
               <input type="hidden" name="id" value = "<?php echo $id; ?> ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="description" name="description" value="<?php echo $description; ?>" placeholder="Description">
                    </div>
                </div>
               <div class="form-group">
                    <label for="max-value" class="col-sm-3 control-label">Max-value</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="" name="max" value="<?php echo $max; ?>" placeholder="Max value to select">
                    </div>
                </div>
                <div class="form-group">
