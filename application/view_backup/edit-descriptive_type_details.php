...
<section class="col-md-9">
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action=" <?php echo base_url() . 'set/descriptive_type_details'; ?>" method="POST">
                ...
                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">Header Name ID</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="descriptive_type_id" required="" value="<?php echo $descriptive_type_id;?>" readonly>
                  </div>
                </div>
                ...
                $filter[1]["id"] = "id";
                $filter[1]["value"] = $id;
                $data = $this->main_model->get_many_records('descriptive_type_details', $filter, '', '');
        ...
        echo 
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="answer_header_text" value="' . $value["answer_header_text"] . '">
                    </div>
                </div>';
