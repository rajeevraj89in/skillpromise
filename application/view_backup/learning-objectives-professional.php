    ...
    <div class="main_body">
        <div class="row">
            ...
            <section class="col-md-9" style="min-height: 395px;">
                ...
                <div class="panel">
                        <h1 class="header_text">Learning Objectives of Self-Assessment and Development Need Analysis Program (SANA)for Professionals:</h1>
                </div> 
                ...
                <div class="text-justify"> 
                    ...
                    <ul class="custom">
                        <li>Learn about their Values, Strengths, Skills, Attitude, Etiquettes, Intelligence Mix, Needs, Hobbies and External Environment.</li>
<li>Explore their Qualities/ Assets in terms ofValues, Strengths, Skills, Attitude and Etiquettes.</li>
<li>Explore their Needs and make informed goals in line with their needs.</li>
<li>Learn about different questions that can be asked related to the components of the program during interviews.</li>
<li>Explore their Areas of Improvement and the way they need to present their Areas of improvement effectively during the interviews.</li>
<li>Explore their hobbies and how to present them productively</li>
<li>Create a Personal SWOT Analysis</li>
<li>Create a PEST Analysis</li>
<li>Explore and understand their intelligence mix and identify their intelligence gap as per the goals that they have set for their life</li>
