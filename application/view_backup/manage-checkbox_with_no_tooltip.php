    ...
    <div class="row text-center">
        <div class="col-md-12">
            <?php if (!empty($template_instruction_id)) { ?>
                <a class="btn btn-primary" href="<?php echo base_url() . 'create/checkbox_with_no_tooltip/' . $template_instruction_id; ?>">Add sheet content</a>
            <?php } else { ?>
                <a class="btn btn-primary" href="<?php echo base_url() . 'create/checkbox_with_no_tooltip/'; ?>">Add sheet content</a>
            <?php }
            ?>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $rec) {
                            $tbl_str.='<tr class="post">'
                                    ...
                                    . '<td class="text-center"><a href="' . base_url() . "edit/checkbox_with_no_tooltip/" . $rec['id'] . '"><span class="glyphicon glyphicon-pencil"></span></a></td>'
                                    . '<td class="text-center"><a href="' . base_url() . "delete/checkbox_with_no_tooltip/" . $rec['id'] . '"><span class="glyphicon glyphicon-trash"></span></a></td>'
                                    . "</tr>";
                        }
