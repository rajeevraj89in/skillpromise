...
//                                    . "<td>" . $rec['header_name'] . "</td>"
                                     . '<td>' . $this->main_model->get_name_from_id('descriptive_type', 'header_name', $rec['descriptive_type_id']) . '</td>'
                                    . "<td>" . $rec['answer_header_text'] . "</td>"
//                                     . '<td>' . $this->main_model->get_name_from_id('descriptive_type_details', 'answer_header_text', $rec['id']) . '</td>'
                                    . '<td class="text-center"><a href="' . base_url() . "edit/descriptive_type_details/" . $rec['id'] . '"><span class="glyphicon glyphicon-pencil"></span></a></td>'
                                    . '<td class="text-center"><a href="' . base_url() . "delete/descriptive_type_details/" . $rec['id'] . '"><span class="glyphicon glyphicon-trash"></span></a></td>'
                                    . "</tr>";
                        }
                        echo $tbl_str;
