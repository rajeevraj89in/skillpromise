...
<script>
    ...
    function fillGrid(JSONtext, gridID) {
        ...
        $.each(JSONobject, function (i, item) {
            ...
            tr.append(td);
            td = $('<td class="text-center"><a href="#" class="delete" data-url="' + base_url + 'delete/node/' + item.id + '"><span class = "glyphicon glyphicon-trash" ></span></a></td>');
            tr.append(td);
        });
    }
