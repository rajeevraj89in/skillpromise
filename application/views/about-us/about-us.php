...
<body>
    ...
    <div class="about-us-page external-pages">
        <div class="main-container">
            <div class="methodology-img-container">
                <h2 class="methodology-heading">
                    About Us
                </h2>
            </div>

            <div class="methodology-text-wraper">
            ...
            <div class="methodology-footer-containt-wraper">
                <div class="methodology-list">

                    <div class="Self-Improvisation-list">
                        <p style="text-align: justify;">
                    ...
                    <div class="Self-Improvisation-list">
                        <p style="text-align: justify;">
                            Skillpromise.com has groomed more than 2000+ students, on various tools used by corporate during campus placement , from management colleges like Mudra Institute of Communications, Ahmedabad, Institute of Management Technology, Hyderabad & Dubai, Birla Institute of Management, Greater Noida and Myra school of business, Mysore
                        </p>
                    </div>
            ...
            <div class="methodology-text-wraper">
                <p style="text-align: justify;">
                    Skillpromise.com has a robust and customizable assessment tool which has been used by companies like L'Oréal. Skillpromise.com has executed two waves of leadership development program called QUEST for Nippon Paints and Automotives with participants from four countries. Skillpromise.com is in the process of executing motivational training programs for parents of children suffering with Type 1 Diabetes for a company called Ypsomed.
                </p>
            </div>
            <div class="content-blocks__buttons-wrapper" style="margin-bottom:15px;">
