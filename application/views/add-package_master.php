...
<section class="col-md-9">
    <h1 class="page-header">Add Package Master</h1>

    <!-- add-program-form content -->
    <div class="row">
        <div class="col-md-12">
            <form enctype="multipart/form-data"  class="form-horizontal" autocomplete="off" role="form"  action="<?php echo base_url(); ?>save_add_package_master" method="POST" onsubmit="return check()">

                <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">Package Master Name</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Package Master Name" required>
                    </div>
                </div>
				<div class="form-group">
                    <label for="description" class="col-sm-3 control-label">Package Master Description</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="description" name="description" placeholder="Package Description" required value = "<?php echo $description = (isset($description))?$description:""; ?>">
                    </div>
                </div>
                <div class="form-group">
