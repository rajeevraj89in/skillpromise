...
<section class="col-md-9">
    <h1 class="page-header">Add Resource Center</h1>
        ...
        <div class="col-md-12">
            <form enctype="multipart/form-data" class="form-horizontal" autocomplete="off" role="form" action="<?php echo base_url(); ?>set/resource_centers" method="POST" onsubmit="return check()">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control editor" id="rc_title" name="title" placeholder="Title"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control editor" id="rc_content" name="content" placeholder="Content"></textarea>
                    </div>
                </div>
