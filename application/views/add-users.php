        ...
        <div class="col-md-12">
            <form enctype="multipart/form-data" class="form-horizontal" role="form" action=" <?php echo base_url() . 'set/users'; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="scu" name="scu" value = "" placeholder="Enter School / College / University Name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="course" name="course" value = "" placeholder="Enter Course Name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="stream" name="stream" value = "" placeholder="Enter Stream Name">
                    </div>
                </div>
