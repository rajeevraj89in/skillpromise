...
<!--                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-3">
                            <button type="submit" value="0" name="draft" class="btn btn-primary dew">Save as Draft</button>
                        </div>
                        <div class="col-sm-3">
                            <button type="submit" value="1" name="draft" class="btn btn-primary dew" id="save">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
