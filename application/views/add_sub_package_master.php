...
<section class="col-md-9">
    <h1 class="page-header">Add Sub Package Master</h1>

    <!-- add-program-form content -->
    <div class="row">
        <div class="col-md-12">
            <form enctype="multipart/form-data"  class="form-horizontal" autocomplete="off" role="form"  action="<?php echo base_url(); ?>save_add_sub_package_master" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Sub Package Master Name" required>
                    </div>
                </div>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea rows="6" class="form-control editor" id="description"  name="description" placeholder="Package Description"></textarea>
                    </div>
                </div>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                        <textarea rows="6" class="form-control editor" id="popup_description"  name="popup_description" placeholder="Package Pop up Description"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <p class="help-block"><img onchange="readURL(this);"
                                src ="<?php echo (base_url() . 'assets/img/uploads/packages/noimage.jpg'); ?>" id="currrentImg" width="100" height="100" style="" alt="Current Image Show">
                                </p>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" name="is_deleted" id="Active" value="0" checked> Active
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="is_deleted" id="Inactive" value="1"> Inactive
                        </label>
                    </div>
                </div>
