...
<!--<header class="header-bg">
   ...
   <div class="h-social-icons">
    ...
    <section class="home-banner-bg">
        ...
        <div class="container">
            <div class="banner-text">
                <h1>Placement Preparation Program</h1>
                <h4>Get Job Ready</h4>
				<p>Skillpromise Placement Preparation Program is an incisive, comprehensive, and credible program that helps you equip yourself with the science and art that goes behind acing your job interview.  Placement Preparation Program prepares you on various testing tools used by companies during the selection process like</p>
            ...
            <div class="banner-list">
                ...
                <div class="list-bg">
                    <p>
                        ...
                        </span> Curriculum Vitae Building
                    </p>
                    <p>
                        <span>
                            <svg class="u-svg-content" viewBox="0 0 24 24" style="width: 1em; height: 1em;">
            ...
            <div class="home-banner-btn">
                <a href="#" data-toggle="modal" data-target="#program_video-tour">Program Video Tour</a>
                <a href="#" data-toggle="modal" data-target="#program_details">Program Presentation</a>
            </div>
        </div>
    </section>
    ...
    <section class="skillpromise-bg">
		...
		<?php foreach ($active_packages as $active_subpackages){
		  $active_subpackage_1 = $active_subpackages[0];	?>
        <div class="container">
            <h4 class="title"><?php echo $active_subpackage_1->package_master_name; ?></b></h4>
			<?php  if(!empty($active_subpackage_1->package_master_description)){ ?>
               <p><?php echo $active_subpackage_1->package_master_description; ?></p>
			<?php }  ?>
            <div class="row pt-3">
            <?php
            foreach ($active_subpackages as $active_subpackage)
            {?>
                <div class="col-md-4 col-lg-3">
                    <div class="skill-box" data-toggle="tooltip" data-placement="right" title="">
                        <img alt="" src="<?= base_url("$active_subpackage->image");?>">
                        <h4><?php echo $active_subpackage->name; ?></h4>
                        <a href="<?= base_url("Programs/$active_subpackage->id");?>" class="glb-btn">Learn More</a>
						<div class="skill-popover-box">
							<div class="card popover-card">
								<div class="card-body">
								    <?php echo $active_subpackage->popup_description; ?>
								</div>
								<a href="<?= base_url("Programs/$active_subpackage->id");?>" class="glb-btn">Learn More</a>
							</div>
						</div>
 ...
 <section class="testimonials-grp-bg" style="padding:40px 0;" >
        <div class="container">
            <div class="row">
                ...
                <div class="w-100 border white-bg">
                    <div class="tab-content">
                        <?php
                            $db = mysqli_connect("localhost", "comskill_skillpromise", '-1VF=8Nt1LFM', "comskillpromise_newadmin");
                            $tab_query = "SELECT * FROM testimonial_category where is_deleted='0' ORDER BY id ASC";
                            $tab_result = mysqli_query($db, $tab_query);
                                ...
                                while($trow = mysqli_fetch_array($tab_result)){
                                    ...
                                    if($i == 0 ){
                                        ...
                                        $li.=  '<li class="nav-item test-li active " style="margin-bottom:10px;" ><a data-id="testimonial'.$trow['id'].'" class=" nav-link test-btn" href="#testimonial'.$trow['id'].'" data-toggle="tab">'.$trow['category'].'</a></li>';
                                  
                                    }else{
                                        $li.=  '<li class="nav-item test-li" style="margin-bottom:10px;"><a data-id="testimonial'.$trow['id'].'" class="nav-link test-btn" href="#testimonial'.$trow['id'].'" data-toggle="tab">'.$trow['category'].'</a></li>';
                        ...
                        <?php
                          foreach($array as $key => $value){
                               if($key == 0){
                                   ?>
                                        <div id="testimonial<?php echo $value['id'];?>" class="tab-pane fade show active">
                                            ...
                                            <div id="myCarousel<?php echo $key; ?>" class="carousel slide" >
                                                <?php
                                                    $id = $value['id'];
                                                    $product_query = "SELECT * FROM testimonials WHERE  is_deleted='0' and status='Active' and cat_id =$id";
                                                    //   echo $product_query;
                                                    ...
                                                    $product_query = "SELECT * FROM testimonials INNER JOIN testimonial_category on testimonials.cat_id=testimonial_category.id  WHERE testimonials.status='Active' and testimonials.is_deleted='0' and  testimonials.cat_id =$id";
                                                    //   echo $product_query;
                                                    $product_result = mysqli_query($db, $product_query);
                                                            $k=0;
                                                            while($sub_rowk = mysqli_fetch_array($product_result)){
                                                                if($k==0)
                                                                {
                                                                        ...
                                                                        <div class="row align-items-center">
                                                                          <div class="col-5" >
                                                                            <div class="testimonial-imgs">
                                                                                <img src="assets/img/uploads/<?= $sub_rowk["image_file"];?>" alt="assets/img/uploads/<?= $sub_rowk["image_file"];?>" style="width:100%;height:100%;">
                                                                            </div>
                                                                          </div>
                                                                    <!--<div class="carousel-caption">-->
                                                                     <div class="col-6">
                                                                         <div class="testimonials-text test-head">
                                                                        <span class="fname"><?= $sub_rowk["full_name"];?></span><br>
                                                                      <span class="author"><?= $sub_rowk['author'];?></span>
                                                                     </div>
                                                                     </div>
                                                                        </div>
                                                                        
                                                                     <div class="testimonials-text" > <p><?= $sub_rowk["detailed_desc"];?></p>
                                                                     </div>                                                     <!--</div>-->
                                                                    </div>
                                                                    <?php
                                                                }else{
                                                                    ...
                                                                    <!--<div class="carousel-caption">-->
                                                                     ...
                                                                     <div class="testimonials-text" > <p><?= $sub_rowk["detailed_desc"];?></p></div>
													...
													<button class="carousel-control-prev" type="button" data-target="#myCarousel<?php echo $key; ?>" data-slide="prev">
														<i class="fa fa-chevron-left" aria-hidden="true"></i>
														<span class="sr-only">Previous</span>
													  </button>
													  <button class="carousel-control-next" type="button" data-target="#myCarousel<?php echo $key; ?>" data-slide="next">
                                   ...
                                   ?>
                                   <div id="testimonial<?php echo $value['id']; ?>" class="tab-pane fade show">
                                       <div id="<?php echo $value['id']; ?>" class="tab-pane fade  show">
                                            <div id="myCarousel<?php echo $key; ?>" class="carousel slide" >
                                                <?php
                                                    $id = $value['id'];
                                                    $product_query = "SELECT * FROM testimonials WHERE status='Active' and is_deleted='0' and cat_id =$id";
                                                    //   echo $product_query;
                                                    $product_result = mysqli_query($db, $product_query);
                                                    ?>
                                                    <ol class="carousel-indicators">
            ...
            <div class="col-md-6">
                ...
                <div class="skillpromise-box">
                    <div class="single-slider owl-carousel owl-theme">
                        <div class="item">
                            <img src="assets/img/WSPconvinience.png" />
                            <h3>CONVENIENCE</h3>
                        ...
                        <div class="item">
                            <img src="assets/img/WSPinformedDecisionMaking.png" />
                        ...
                        <div class="item">
                            <img src="assets/img/WSPenhancedConfidenceLevels.png" />
                        ...
                        <div class="item">
                            <img src="assets/img/WSPinstantReturnOnLearning.png" />
                        ...
                        <div class="item">
                            <img src="assets/img/WSPeasyInformationAccess.png" />
                        ...
                        <div class="item">
                            <img src="assets/img/WSPcomprehensiveContent.png" />
                        ...
                        <div class="item">
                            <img src="assets/img/WSPprivacy.png" />
                            <h3>Privacy</h3>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="grey-bg">
                    ...
                    <div class="single-slider owl-carousel owl-theme assesment-center">
                        <div class="item">
                            <div class="asse-img">
                            ...
                            <div class="asse-text">
                                ...
                                <a href="<?php echo(base_url() . "home_sheets_wellness/sheets/43"); ?>" class="glb-btn">Learn More</a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="asse-img">
                    ...
                    <div class="grey-bg">
                        ...
                        <div class="form-box-bg">
                            <div class="form-content">
                                ...
                                echo "<p style='color:red;margin:-5px;'>$msg</p>";
                                ?>
...
<section class="resource-center-sec">
	<div class="container">
		<div class="row">
			 <div class="col-md-6">
				<div class="glb-title px-3">
				...
				<div class="resource-center-slider owl-carousel owl-theme">
				    <?php
						if (!empty($resource_center)) {
							foreach ($resource_center as $key => $value) {
						?>
								<div class="item">
									<div class="resource-center-card">
										<img src="<?php echo (base_url() . 'assets/img/uploads/rs_images/' . $value['image_file']); ?>" />
										<div class="recource-details">
					...
					<!--<div class="item">-->
					<!--	<div class="resource-center-card">-->
					<!--		<img src="<?php echo(base_url() . 'assets/img/resource-center/' . 'statement-of-purpose.jpg'); ?>" />-->
					<!--		<div class="recource-details">-->
					<!--			<h2>Create an impactful <strong>STATEMENT OF PURPOSE</strong></h2>-->
					<!--			<p>A Statement of Purpose is a description of who you are as a student and what you are looking for in your career. -->
					<!--			You are required to make an SOP  when you apply for admission to a college. As an interviewee, you can be probed about your career -->
					<!--			aspirations and goals, by the employer. This section will mentor you on how to make an impactful SOP</p>-->
					<!--		</div>-->
					<!--	</div>-->
					<!--</div>-->
					<!--<div class="item">-->
					<!--	<div class="resource-center-card">-->
					<!--		<img src="<?php echo(base_url() . 'assets/img/resource-center/' . 'extempore-speech.jpg'); ?>" />-->
					<!--		<div class="recource-details">-->
					<!--			<h2>Learn the Art of  <strong>ESSAY WRITING</strong></h2>-->
					<!--			<p>Essay writing is a tool required equally by students and professionals. Essay writing helps in evaluation of creativity, -->
					<!--			writing skills, persuasion skills, intelligence, though speed, critical thinking and communication. Learn how to take a -->
					<!--			deep dive into a topic, analyze it, share your thoughts, and supplement them with facts.</p>-->
					<!--		</div>-->
					<!--	</div>-->
					<!--</div>-->
					<!--<div class="item">-->
					<!--	<div class="resource-center-card">-->
					<!--		<img src="<?php echo(base_url() . 'assets/img/resource-center/' . 'essay-writing.jpg'); ?>" />-->
					<!--		<div class="recource-details">-->
					<!--			<h2>Excel in  <strong>EXTEMPORE SPEECH</strong></h2>-->
					<!--			<p>An Extempore speech is an impromptu speech which the candidate is required to make on a topic given there and then. -->
					<!--			You are expected to start speaking about the topic as soon the topic is announced by the interviewer. Extempore is -->
					<!--			used by some employers to check your creativity, thought speed, communication and thought process. Learn how to successfully -->
					<!--			approach extempore on different types of topics</p>-->
					<!--		</div>-->
					<!--	</div>-->
					<!--</div>-->
					<!--<div class="item">-->
					<!--	<div class="resource-center-card">-->
					<!--		<img src="<?php echo(base_url() . 'assets/img/resource-center/' . 'linkedin-profile.jpg'); ?>" />-->
					<!--		<div class="recource-details">-->
					<!--			<h2>Build a great <strong>LINKEDIN PROFILE</strong></h2>-->
					<!--			<p>LinkedIn is world’s largest professional network. Whether you are an experienced professional or just getting started, -->
					<!--			having a great LinkedIn profile is an absolute must. Learn about essential components of a LinkedIn profile like how to -->
					<!--			write professional summary, how to present internships, projects and work experience, how to manage endorsements and -->
					<!--			recommendations, how to join relevant groups etc.</p>-->
					<!--		</div>-->
					<!--	</div>-->
					<!--</div>-->
				</div>
			 ...
			 <div class="col-md-6">
				...
				<div class="clients-slider owl-carousel owl-theme" id="corporate">
						<?php
						if (!empty($corporate_clients)) {
							foreach ($corporate_clients as $client) {
						?>
								<div class="item">
									<div class="clients-card">
										<img src="<?php echo (base_url() . 'assets/img/uploads/clients/' . $client['image_file']); ?>" />
									</div>
								</div>
						<?php
							}
					...
					<div class="clients-slider owl-carousel owl-theme d-none" id="educational">
						<?php
						if (!empty($educational_clients)) {
							foreach ($educational_clients as $client) {
						?>
								<div class="item">
									<div class="clients-card">
										<img src="<?php echo (base_url() . 'assets/img/uploads/clients/' . $client['image_file']); ?>" />
					...
					<div class="row" style="align-items:center;justify-content:center;margin-top:5px;">
						<a style="padding: 8px 20px;transition: all 0.2s ease;border-radius: 25px;margin-right:5px;background: #ff7043;color: #ffffff !important;font-weight: bold !important;" id="btn-corp">Corporate</a>
						<a style="padding: 8px 20px;transition: all 0.2s ease;border-radius: 25px;background: #ff7043;color: #ffffff !important;font-weight: bold !important;" id="btn-edu">Educational</a>
					</div>
			 </div>
		</div>
	</div>
...
<div class="modal fade" id="program_video-tour" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
      ...
      <div class="modal-body">
		<div class="program-video-tour">
			<video style="width:100%;" controls autoplay  muted playsinline>
			  <source src="<?php echo(base_url() . 'assets/img/program/' . 'video_skillpromise.mp4'); ?>" type="video/mp4">
...
<style>
.program-video-tour video {width:100%;}
</style>
<script>
$(document).ready(function(){
$('.toggle-btn').click(function(e){ 
	...
	$("#btn-corp").css("background-color", "green");

	$("#btn-corp").on("click", function() {
		$("#btn-edu").css("background-color", "#ff7043");
		$("#btn-corp").css("background-color", "green");
		$("#corporate").removeClass("d-none");
		$("#educational").addClass("d-none");
	});

	$("#btn-edu").on("click", function() {
		$("#btn-corp").css("background-color", "#ff7043");
		$("#btn-edu").css("background-color", "green");
		$("#educational").removeClass("d-none");
