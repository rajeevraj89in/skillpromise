    ...
    <div class="main_body">
        <div class="row">
            ...
            <section class="col-md-9">
                <div class="panel">
                    <h1 class="header_text" style="color:#25897a; text-align: left;" >Credibility Building Skills Analysis</h1>
                </div>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12 top-margin">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="">
                                <tbody>
                                    <tr>
                                        <td class="col-md-4"><span style="color: #24b04f; text-align: center; width:25%;">More Than 75%</span></td>
                                        <td class="col-md-8 text-justify">Congratulations! You display good efficiency in various Building Credibility Areas. Subscribe to our Monthly Newsletter and Improve your Rapport Building Skills, by downloading 'Art of Building Credibility e-Book' as a subscription bonus</td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-4"><span style="color: #f7c004; text-align: center;">51 - 75 %</span></td>
                                        <td class="col-md-8 text-justify">You display some traits of various Building Credibility Areas but there is scope for improvement. Subscribe to our Monthly Newsletter and Improve your Rapport Building Skills, by downloading 'Art of Building Credibility e-Book' as a subscription bonus</td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-4"><span style="color: #f61a00; text-align: center;">50% or less</span></td>
                                        <td class="col-md-8 text-justify">You have immense opportunity in improving your effectiveness in various Building Credibility Areas. Subscribe to our Monthly Newsletter and Improve your Rapport Building Skills, by downloading 'Art of Building Credibility e-Book' as a subscription bonus</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
