        ...
        <div class="row">
            ...
            <section class="col-md-9">
                ...
                <div class="row top-margin">
                        ...
                        <div class="col-md-12" ><h5 style="padding: 10px 10px; background-color: #01897b; color: #fff;">Wellness Overall Score Analysis</h5></div>
                        <div class="col-md-12 ">
...
?>
            ...
            var options = {
                title: "Wellness Score Percentage",
