...
foreach ($subquestions as $question) {
    ...
    . '<label for = "inputOption4" style="font-weight: 100 !important;" class = "col-sm-2 control-label">' .'Question '. $i . '.</label>'
    . '<div class = "col-sm-10">'
    ...
    . '</div>'
    . '<div class = "col-xs-12">'        
    . '<label for = "inputOption4" style="font-weight: 100 !important;" class = "col-sm-2 control-label">'.'Answer '.$i.'.</label>'
    . '<div class = "col-sm-10">'
    . '<div class = "form-group">'        
        ...
        <div class = "col-xs-2 col-sm-2 col-md-2 col-lg-2">
            <div class="row">
                <div class="col-md-6 col-xl-6">
                   <span class="likebadge" id="likebadge">'.$likes.'</span>
                   <span class="glyphicon glyphicon-thumbs-up icon_size like_btn '.$f.'" id='.$question['id'].' data-id="1"></span> 
                </div>
                <div class="col-md-6 col-xl-6">
                   <span class="unlikebadge" id="unlikebadge" style="right: 38px !important;">'.$dislikes.'</span>
