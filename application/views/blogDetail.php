                        ...
                        <link rel="icon" href="<?php echo(base_url() . 'assets/img/' . 'animated_favicon.gif'); ?>" type="image/x-icon">
                            ...
                            <body class="manager-home login">
                                ...
                                <nav class="container navbar navbar-expand-md navbar-light">
                                    <div class="main-logo">
                                        <a href="<?php echo base_url(); ?>"><img src="<?php echo(base_url() . 'assets/images/logo.png'); ?>" class="logo-image" alt="Logo"></a>
                                    </div>
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        <nav class="main-menu">
                                            <ul class="main-ul navbar-nav mr-auto">
                                                <li class="nav-item"><a class="active" href="<?php echo base_url(); ?>">Home</a></li>
                                                <li class="nav-item"><a href="<?php echo base_url(); ?>about-us">About Us</a></li>
                                                <li class="nav-item"><a href="<?php echo base_url(); ?>blogList">Blog 1</a></li>
                                                <li class="nav-item"><a href="<?php echo base_url(); ?>contact-us">Contact Us</a></li>
                                            </ul>
											
                                        </nav>
										<div class="h-login-bg ">
													<a  href="<?php echo base_url(); ?>signin" class="login-btn">LOGIN</a>
											</div>
                                        
                                        <div class="h-social-icons" >
                                            <a class="h-facebook" title="facebook" target="_blank" href="https://www.facebook.com/skillpromisetool"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                            <a class="h-twitter" title="twitter" target="_blank" href="https://twitter.com/skillpromise"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                            <a class="h-instagram" title="instagram" target="_blank" href=""><i class="fa fa-instagram" aria-hidden="true"></i></a>
                                            <a class="h-linkedIn" target="_blank" title="LinkedIn" href="https://www.linkedin.com/company/skill-promise/"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                        </div>
                            ...
                            <!--news letter inner end-->
                                                                        ...
                                                                        <section class="col-md-12" style="min-height: 395px;">
                                                                            ...
                                                                            <div class="text-justify">
                                                                                ...
                                                                                <img src="<?php echo base_url() . '/assets/img/uploads/' . $image_file; ?>" >
																				</div>
																				<br>
