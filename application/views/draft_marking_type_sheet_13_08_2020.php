...
//
                                ...
                                <tr style="background-color: #01897b; color: #ffffff; border-color: #fff;">
                                    <?php
                                    echo'<th class="text-center" width="10%">S. No.</th>';
                                    foreach ($headerName as $header) {
                                        echo'<th class="text-left">' . $header['header_name'] . '</th>';
                                    }
                                    ?>
                                </tr>
                            </thead>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <center>
                            <button type="submit" value="0" name="draft" class="btn btn-success">Save as Draft</button>&nbsp;<a class="btn btn-success" href="<?php echo base_url() . 'analytics/key_values/' . $sheet_id . "/" . $sheet_section_id; ?>">Show Result</a>
                        </center>
