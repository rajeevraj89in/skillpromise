            ...
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo base_url() . 'set_data/save_data_dropdown_with_multi_addmore'; ?>" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <!--EXTERNAL-->
                        <div id="ext_add_earn">
                            <div id="ext_earn" class="ext_etype mt-2" style="display: none;">
                                <div class="well">
                                    <div class="row">
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <label for="statement" class="col-lg-3 control-label">Area of Improvement</label>
                                                <div class="col-lg-8">
                            ...
                            if (isset($draft_data)) {
                                ...
                                foreach ($draft_data as $key => $value) {
                                    ...
                                    <div id="ext_earn<?php echo $i; ?>" class="ext_etype" style="">
                                        <div class="well">
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-control category" name="impovement[<?php echo $i; ?>][category]">
                                                                <option value=""> -- Select a option -- </option>
                                                                <?php
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <div class="col-lg-3 control-label">
                                                            <label for="statement">Area of Improvement</label>
                                                        </div>
                                                        ...
                                                        ?>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control statement" placeholder="Statement" value="<?php echo $statement; ?>" name="impovement[<?php echo $i; ?>][statement]">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" id="add_earn<?php echo $i; ?>" class="internal_main_div">
                                                ...
                                                foreach ($value as $key1 => $value_row) {
                                                    ?>
                                                    <div id="earn<?php echo $j; ?>" class="etype col-md-12" style="">
                                                        <div class="col-md-10">
                                                            <div class="form-group">
                                                                <div class="col-sm-3 control-label">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <textarea rows='10' cols='50' class="form-control action_value" name="impovement[<?php echo $i; ?>][action_value][<?php echo $j; ?>]"><?php echo $value_row['action_values'] ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <!--<div class="form-group text-center">-->
                                            <!--    <span class="btn btn-sm btn-default inter_add_more_button" id="add_earn_div<?php echo $j; ?>">Add Action Item</span>-->
                                            <!--</div>-->
                                        ...
                                        <!--<div class="row">-->
                                        <div class="col-md-3">
                                            <span class="btn btn-sm btn-danger ext_remove_earn" id="ext_remove_earn<?php echo $j; ?>" onclick="ext_removediv(this);">Remove <?php echo $button_label; ?></span>
                                        </div><br><br>
                                    </div>
