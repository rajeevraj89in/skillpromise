<?php
//Created:Dewangshu , 24/08/2017 for edit/Save as Draft data of "tickmark type sheet"
$this->load->view('header_view');
$this->load->view('user_left_view');
?>
<section class="col-md-9">
    <h1 class="header_text">(Saved)<?php
        ...
        <div class="col-md-12">
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo base_url() . 'set_data/save_data_tickmark_type'; ?>" method="POST">
                                    ...
                                    foreach ($question_data as $k=>$val) {
                                        //-----for prev data
                                            ...
                                            foreach ($draft_data as $key_d => $val_draft) {
                                                if($val_draft['tickmark_type_id']==$val['id']){
                                                    $ch=1;
                                                    $prev_content=$val_draft['tickmark_type_header_id'];
                                                    break;
                                                }
                                            }
                                            //-----
                ...
                <div class="form-group">
                    <div class="col-sm-3">
                        <button type="submit" value="0" name="draft" class="btn btn-primary">Save as Draft</button>
                    </div>
                    <div class="col-sm-3">
                        <button type="submit" value="1" name="draft" class="btn btn-primary">Submit</button>
                    </div>
                </div>
            </form>
        </div>
