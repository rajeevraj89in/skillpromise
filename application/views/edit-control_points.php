        ...
        <div class="col-md-12">
            <form enctype="multipart/form-data" class="form-horizontal" role="form" action=" <?php echo base_url() . 'set/control_points'; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="name" name="name" value = "<?php echo $name; ?>" placeholder="Control Point Name" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" id="description" name="description" placeholder="Control Point Description"><?php echo $description; ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group" style="display:none">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="entity" name="entity_id" value = "<?php echo $entity_id; ?>" placeholder="Select entity">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="controller" name="controller" value = "<?php echo $controller; ?>" placeholder="Select Function" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="page" name="page" value = "<?php echo $page; ?>" placeholder="Select Page" required>
                    </div>
                </div>
