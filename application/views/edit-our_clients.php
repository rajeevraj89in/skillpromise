...
<section class="col-md-9">
    <h1 class="page-header">Edit Our Client</h1>

    <!-- add-program-form content -->
    <div class="row">
        <div class="col-md-12">
            <form enctype="multipart/form-data" class="form-horizontal" autocomplete="off" role="form" action="<?php echo base_url(); ?>set/our_clients" method="POST" onsubmit="return check()">
                <input type="hidden" name="id" value="<?php echo $id; ?>" />
                <div class="form-group">
                    <label for="full_name" class="col-sm-3 control-label">Client Name</label>
                    <div class="col-sm-9">
                        <input class="form-control" id="client_name" name="client_name" placeholder="Client Name" value="<?php echo $client_name; ?>"/>
                    </div>
                </div>
                
                <div class="form-group">
                    <label for="client_type" class="col-sm-3 control-label">Customer Type</label>
                    <div class="col-sm-9">
                        <select class="form-control" id="client_type" name="client_type">
                            <option value="">Select Client Type</option>
                            <option value="Corporate" <?php echo ($client_type == "Corporate") ? "selected" : ""; ?>>Corporate</option>
                            <option value="Educational" <?php echo ($client_type == "Educational") ? "selected" : ""; ?>>Educational</option>
                        </select>
                    </div>
                </div>
