        ...
        <div class="col-md-12">
            <form method="post" class="form-horizontal" role="form" autocomplete="off" id="mainForm" action="<?php echo base_url(); ?>set/questions">
                ...
                <div class="form-group option_container_div" id="option_container_div">
                    ...
                    <?php
                    foreach ($child_data as $k2 => $lid) {
//                        print_r($lid[option_number]);
//                        die;
                        ?>
                        <div class="col-xs-12 option_div" id="option_div<?php echo $lid['option_number']; ?>" style="">
                            <input type="hidden" class="option_number" value = "<?php echo $lid['option_number']; ?>" name="<?php echo 'children[' . $lid['option_number'] . '][option_number]'; ?>">
                            <label for="Option" class="col-sm-3 control-label opt_label">Option <?php echo $lid['option_number']; ?></label>
                            <div class="well col-sm-9">

                                <div class="form-group">
                                    <label for="option_text" class="col-sm-3 control-label opt_text" >Option Text</label>
                                    <div class="col-sm-9">
                                        <textarea class="skill_editor"
                                                  id="skill_editor_2<?php echo $lid['option_number']; ?>"
                                                  name="children[<?php echo $lid['option_number']; ?>][option_text]"
                                                  >
                                                      <?php echo $lid['option_text']; ?>
                                        </textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="correctBox-<?php echo $lid['option_number']; ?>" value="<?php echo $lid['is_correct']; ?>" class="correct" <?php
                                            if ($lid['is_correct'] == 1)
                                                echo 'checked';
                                            ?>
                                                   name="children[<?php echo $lid['option_number']; ?>][is_correct]"
                                                   onclick="checkCorrectOption(this);"> &nbsp;
                                        </label>
                                    </div>
                                    ...
                                    <label for ="weight" class="col-sm-3 control-label weight_text weight_elements">Option Weight</label>
                                    <div class="col-sm-3 weight_elements">
                                        <input type="number" class="form-control weight_text weight_box" name="children[<?php echo $lid['option_number']; ?>][option_weight]" id="weight-<?php echo $lid['option_number']; ?>" placeholder="Option Weight" min="0" max="100" value="<?php echo $lid['option_weight']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-offset-10 col-md-2">
                                        <!-- Remove option btn -->
                                        <button type="button" class="btn btn-danger remove" id="remove<?php echo $lid['option_number']; ?>" onclick="removeDiv(this);" >Remove</button>
                                    </div>
                                </div>
...
<script type="text/javascript">
    var options =<?php echo $no_of_options; ?>
