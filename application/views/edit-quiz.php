                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" id="quiz_category" name="quiz_category">
                            ...
                            <option value="TopicWise" <?php echo (($quiz_category == "TopicWise") ? 'selected' : '') ?>>Topic Wise</option>
                            <option value="Comprehensive"  <?php echo (($quiz_category == "Comprehensive") ? 'selected' : '') ?>>Comprehensive</option>
                        </select>
                    </div>
                </div>
