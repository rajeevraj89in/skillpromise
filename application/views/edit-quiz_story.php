...
<section class="col-md-9">
    <h1 class="page-header">Edit Quiz Story</h1>
    <!-- add-program-form content -->
    <div class="row">
        <div class="col-md-12">

            <form enctype="multipart/form-data" class="form-horizontal" role="form" action=" <?php echo base_url() . 'set/quiz_story'; ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Quiz Story Name" value = "<?php echo $name; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="skill_editor" name="story_content" id="page_content" ><?php echo $story_content; ?></textarea>
                    </div>
                </div>
