  ...
  <div class="form-group" id="act_label">
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" name="show_in_frontend" id="show_in_frontend0" value="0" <?php
                            if ($show_in_frontend == '0') {
                                echo 'checked';
                            }
                            ?> >  No
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="show_in_frontend" id="show_in_frontend1" value="1" <?php
                            if ($show_in_frontend == '1') {
                                echo 'checked';
                            }
                            ?>> Yes
                        </label>
