        ...
        <div class="col-md-12">
            <form enctype="multipart/form-data"  class="form-horizontal" autocomplete="off" role="form"  action="<?php echo base_url(); ?>set/testimonials" method="POST" onsubmit="return check()">
                ...
                <input type="hidden" id="edit_id" name="id" value = "<?php echo $id; ?>">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Full Name" required value = "<?php echo $details['full_name']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="cat_id" class="form-control">
                            <?php 
                            foreach($testimonials as $testimonial_categories)
                            {?>
                            <option value="<?= $testimonial_categories->id; ?>"><?= $testimonial_categories->category; ?></option>
                            <?php
                            }?>
                        </select>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <label for="image_file" class="col-sm-3 control-label">Image File</label>
                    <div class="col-sm-9">
