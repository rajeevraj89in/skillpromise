    ...
    <div class="row">
        <div class="col-md-12">
            <form enctype="multipart/form-data" class="form-horizontal" role="form" action=" <?php echo base_url() . 'set/users'; ?>" method="POST">
                ...
                <div class="form-group">
                    <label for="password" class="col-sm-3 control-label">Create New Password</label>
                    <div class="col-sm-9">
                        <input type="password" class="form-control" id="password" name="password" value = "" placeholder="Create New Password">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="scu" class="col-sm-3 control-label">School / College / University</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="scu" name="scu" value = "<?php echo $scu; ?>" placeholder="Enter School / College / University Name">
                    </div>
                </div>
                
                <div class="form-group">
                    <label for="scu" class="col-sm-3 control-label">Course</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="course" name="course" value = "<?php echo $course; ?>" placeholder="Enter Course Name">
                    </div>
                </div>
                
                <div class="form-group">
                    <label for="scu" class="col-sm-3 control-label">Stream</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="stream" name="stream" value = "<?php echo $stream; ?>" placeholder="Enter Stream Name">
                    </div>
                </div>
