    ...
    <div class="body">
        <div >
            ...
            <section  style="min-height: 395px;">
                ...
                <div class="panel">
                    <h1 class="header_text"><?php echo $sheet->name; ?></h1>
                ...
                <div class="text-justify">
                     ...
                     Etiquette are conventional requirements as to social behavior; proprieties of conduct as established in any class or community or for any occasion. 
					   ...
					   <img style="width:100%;" class="img-responsive" alt="" src="<?php echo(base_url() . 'assets/img/' . 'etiquette-inside.jpg'); ?>" >
                    <br>
                    <blockquote>
