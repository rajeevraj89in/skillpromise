...
<section class="col-md-9">
    ...
    <div class="row text-center">
        <div class="col-md-12">
            <a class="btn btn-primary" href="<?php echo base_url() . 'create/listing_type/' . $template_instruction_id; ?>">Add sheet content</a>
        </div>
    </div>
    <hr>
    <!-- Table content -->
                    ...
                    <tbody>
                        ...
                        foreach ($data as $rec) {
                            $tbl_str.='<tr class="post">'
                                    ...
                                    . '<td class="text-center"><a href="' . base_url() . "edit/listing_type/" . $rec['id'] . '"><span class="glyphicon glyphicon-pencil"></span></a></td>'
                                    . '<td class="text-center"><a href="' . base_url() . "delete/listing_type/" . $rec['id'] . '"><span class="glyphicon glyphicon-trash"></span></a></td>'
                                    . "</tr>";
                        }
                        echo $tbl_str;
                        ?>
