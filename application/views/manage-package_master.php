...
<section class="col-md-9">
    <h1 class="page-header">Manage Package Master</h1>
    <div class="row text-center">
        <div class="col-md-12">
            <a class="btn btn-primary" href="<?php echo base_url('add_package_master'); ?>">Add Package Master</a>
        </div>
    </div>
    <hr>
    <!-- Table content -->
                    ...
                    <tbody>
                        ...
                        foreach ($data as $rec) {
                            $tbl_str .= '<tr class="post">'
                                    . "<td>" . $count++ . "</td>"
                                    . "<td>" . $rec['name'] . "</td>"
                                    . "<td>" . (($rec['is_deleted'] == 0)?("Active"):("Inactive")) . "</td>"
                                    . '<td class="text-center"><a href=' . base_url() . "edit/package_master/" . $rec['id'] . '><span class="glyphicon glyphicon-pencil"></span></a></td>'
                                    . '<td class="text-center"><a href="#" class="delete" data-url="' . base_url() . "delete/package_master/" . $rec['id'] . '"><span class="glyphicon glyphicon-trash"></span></a></td>'
                                    . "</tr>";
                        }
                        echo $tbl_str;
                        ?>
