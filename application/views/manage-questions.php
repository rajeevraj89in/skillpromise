...
<section class="col-md-9">
    ...
    <div class="row text-center">
        <div class="col-md-12">
            ...
            <button type = "button" id = "addLink" class = "btn btn-primary">Add Question</button>
        </div>
    </div>
    <hr />
...
//                else {
//                    echo '<div class="form-group space-bootom level-div" id="leveldiv" style="display:none">
...
//                    . $this->main_model->fill_node_select() .
//                    '</select>
//                    </div>
//                </div>';
//                }
                        ...
                        if ($data) {
                            foreach ($data['grid_data'] as $key => $value) {
                                ...
                                . "<td>" . ($key + 1) . "</td>
                                    ...
                                    <td>$value[question_weight]</td>"
                                . '<td class="text-center"><a href="' . base_url() . "edit/questions/$value[id]/options/question_id/option_number" . '"><span class="glyphicon glyphicon-pencil"></span></a></td>'
                                . '<td class = "text-center"><a href = "' . base_url() . "delete/questions/$value[id]/options/question_id/option_number" . '"><span class = "glyphicon glyphicon-trash"></span></a></td>'
                                . '</tr>';
                            }
                        } else {
                            echo '<tr class = "post">
...
//            no_of_childs = parseInt(no_of_childs);
    ...
    $(document).ready(function () {
        $("#show").click(function () {
            window.open(base_url + "manage/questions/" + parent_id, "_self");
        });
        $("#addLink").click(function () {
           if(parent_id != 0){
                window.open(base_url + "add/questions/" + parent_id, "_self");
             }
        });
    });
</script>
