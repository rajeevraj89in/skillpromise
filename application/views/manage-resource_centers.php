...
<section class="col-md-9">
    <h1 class="page-header">Manage Resource Center</h1>
    <div class="row text-center">
        <div class="col-md-12">
            <a class="btn btn-primary" href="<?php echo base_url() . 'add/resource_centers'; ?>">Add Resource Center</a>
        </div>
    </div>
    <hr>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $rec) {
                            $tbl_str .= '<tr class="post">'
                                ...
                                . "<td>" . $rec['title'] . "</td>"
                                . "<td>" . $rec['content'] . "</td>"
                                . "<td><img style='height:200px;width:180px' src='" . base_url() . "assets/img/uploads/rs_images/" . $rec['image_file'] . "'> </td>"
                                . "<td>" . $rec['status'] . "</td>"
                                . '<td class="text-center"><a href=' . base_url() . "edit/resource_centers/" . $rec['id'] . '><span class="glyphicon glyphicon-pencil"></span></a></td>'
                                . '<td class="text-center"><a href="#" class="delete" data-url="' . base_url() . "delete/resource_centers/" . $rec['id'] . '"><span class="glyphicon glyphicon-trash"></span></a></td>'
                                . "</tr>";
                        }
                        echo $tbl_str;
                        ?>
