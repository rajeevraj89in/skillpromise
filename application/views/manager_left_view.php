...
//                }
                        ...
                        //   if ($this->custom->validate_permissions("manage", "news_letter", "") == 7) {
                        //     echo '<li><a href = "' . base_url() . 'manage/program_category">Manage Program Category</a></li>';
                        // }
                        if ($this->custom->validate_permissions("manage", "news_letter", "") == 7) {
                            echo '<li><a href = "' . base_url() . 'analytics/SummaryReport">Summary Report</a></li>';
                        }
                        // if ($this->custom->validate_permissions("manage", "news_letter", "") == 7) {
                        //     echo '<li><a href = "' . base_url() . 'pdf_generation_action_sheet">Download Action Sheet PDF</a></li>';
                        // }
...
//                        echo '<li><a href = "' . base_url() . 'manage/package_category">Manage Packages Category</a></li>';
                        echo '<li><a href = "' . base_url() . 'manage/package_master">Manage Package Master</a></li>';
                        echo '<li><a href = "' . base_url() . 'manage/package_sub_master">Manage Package Sub Master</a></li>';
                        echo '<li><a href = "' . base_url() . 'manage/packages">Manage Packages</a></li>';

                        echo '<li><a href = "' . base_url() . 'manage/sheets">Manage Action Sheets</a></li>';
                        echo '<li><a href = "' . base_url() . 'manage/actionsheet_category">Manage Action Sheet Category</a></li>';
                        echo '<li><a href = "' . base_url() . 'manage/testimonial_category">Manage Testimonial category</a></li>';
                        echo '<li><a href = "' . base_url() . 'manage/testimonials">Manage Testimonials</a></li>';
                        echo '<li><a href = "' . base_url() . 'manage/resource_centers">Manage Resource Centers</a></li>';
                        echo '<li><a href = "' . base_url() . 'manage/our_clients">Manage Our Clients</a></li>';
...
//                }
                        ...
                        if ($this->custom->validate_permissions("add", "node", "") == 7) {
                         ...
                         if ($this->custom->validate_permissions("manage", "news_letter", "") == 7) {
                            echo '<li><a href = "' . base_url() . 'manage/testimonial_category">testimonial_category</a></li>';
                        }
                        ...
                        echo '<li><a href = "' . base_url() . 'add/resource_centers">Add Resource Center </a></li>';
                        
                        echo '<li><a href = "' . base_url() . 'add/our_clients">Add Our Clients </a></li>';
                        
                        // if ($this->custom->validate_permissions("add", "testimonials", "") == 7) {
                        //     echo '<li><a href = "' . base_url() . 'add/programmorecontents">Add Program Contents </a></li>';
                        // }
                        ?>
                    </ul>
                </div>
