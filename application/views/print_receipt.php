...
$row = $this->db->query('SELECT * FROM `payment_detail`')->row();
$invoice_string = "";
$invoice_id = $row->id;
$invoice_id = 0;
...
$payment_details = $this->main_model->get_records_from_id("payment_detail", $payment_id, "id");
?>
<style type="text/css">
    /* Styles go here */
...
<tr>
    ...
    <td valign="middle" class="text-left">249.0</td>
                                        ...
                                        --><tr>
                                            ...
                                            <td valign="middle" class="text-right"><?php echo round($payment_details['amount'],2); ?><?php echo round($amount, 2) ?></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td valign="middle" class="text-right"><?php echo $gst = round((18 * $payment_details['amount']) / 100, 2); ?></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="font-size: 18px;" valign="middle" class="text-right"><?php echo round(($payment_details['amount']+ $gst), 2) ?></td>
