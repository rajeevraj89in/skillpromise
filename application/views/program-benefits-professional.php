    ...
    <div class="main_body">
        <div class="row">
            ...
            <section class="col-md-9" style="min-height: 395px;">
                ...
                <div class="panel">
                        <h1 class="header_text">Benefits of Self-Assessment & Development Need Analysis Program(SANA) for Professionals</h1>
                </div> 
                ...
                <div class="text-justify"> 
                    ...
                    <p>Self-Assessment and Development Need Analysis Program (SANA) will help you understand yourself in terms of your Qualities, Areas of Improvement, Goals, Hobbies, Needs, Etiquettes, Attitude and External environment. This will enable you to make informed decisions and pursue your goals with enhanced confidence.</p>
