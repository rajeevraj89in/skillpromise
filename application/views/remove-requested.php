...
<section class="col-md-9">
    <h1 class="page-header">All Request</h1>
    <div class="row">
                    ...
                    <tbody>
                        ...
                        foreach ($quiz_result as $rec) {
                            $tbl_str .= '<tr class="post">'
                                    ...
                                    . "<td>" . $rec['request_time'] . "</td>"
                                    . "<td>" . $rec['student_name'] . "</td>"
                                    . "<td>" . $rec['quiz_name'] . "</td>"
                                    . "<td>" . $rec['start_time'] . "</td>"
                                    . "<td>" . $rec['submit_time'] . "</td>"
                                    . '<td class="text-center"><a href=' . base_url() . "delete_result/requested/" . $rec['quiz_result_id'] . '"><span class="glyphicon glyphicon-trash"></span></a></td>'
                                    . "</tr>";
                        }
