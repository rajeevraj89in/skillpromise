...
<!-- <div class="container">
    <div class="main_body">
        <div id="bigCallout">
            ...
            <div class="login-home-section d-flex">

                <a class="prog-block" href="#!">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico1.png'); ?>" >
                    <span>MBA Entrance Examinations Introduction</span>
                </a>
                <a class="prog-block" href="<?php echo base_url('node/program/15'); ?>">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico2.png'); ?>" >
                    <span>Aptitude Development</span>
                </a>
                <a class="prog-block" href="<?php echo base_url('node/program/2331'); ?>">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico3.png'); ?>" >
                    <span>Written Ability Test</span>
                </a>
                <a class="prog-block" href="<?php echo base_url('node/program/2310'); ?>">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico4.png'); ?>" >
                    <span>Guesstimation</span>
                </a>
                <a class="prog-block" href="<?php echo base_url('cv'); ?>">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico5.png'); ?>" >
                    <span>Curriculum Vitae</span>
                </a>
                <a class="prog-block" href="#!">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico6.png'); ?>" >
                    <span>Self-Assessment</span>
                </a>
                <a class="prog-block" href="<?php echo base_url('node/program/2015'); ?>">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico7.png'); ?>" >
                    <span>Group Discussions</span>
                </a>
                <a class="prog-block" href="<?php echo base_url('node/program/2207'); ?>">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico8.png'); ?>" >
                    <span>Personal Interview</span>
                </a>
                <a class="prog-block" href="<?php echo base_url('node/program/2354'); ?>">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico9.png'); ?>" >
                    <span>Statement of Purpose</span>
                </a>
                <a class="prog-block" href="<?php echo base_url('node/program/2355'); ?>">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico10.png'); ?>" >
                    <span>Letter of Recommendation</span>
                </a>
                <a class="prog-block" href="<?php echo base_url('node/program/2330'); ?>">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico11.png'); ?>" >
                    <span>General Awareness</span>
                </a>
                <a class="prog-block" href="#!">
                    <img class="img-responsive" src="<?php echo(base_url() . 'assets/img/icons/' . 'ico12.png'); ?>" >
                    <span>Resources</span>
                </a>
    ...
    <div class="dooble-border">
        <div class="page-header_">
            <div class="panel">
                ...
                <?php
                 $id = $_SESSION['student_package_id'];
