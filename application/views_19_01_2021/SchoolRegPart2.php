                        ...
                        <form method="post" role="form" action=" <?php echo base_url() . 'UserRegPart3'; ?>">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input id="fname" type="text" name="org_name" placeholder="Name of the School" class="form-control" required="">
                                </div>
                            </div>
							<div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label sr-only " for="Name"></label>
                                    <input id="dob" type="date" name="dob" placeholder="Date Of Birth DD MM YYYY" class="form-control">
                                </div>
                            </div>
