...
<section class="col-md-9">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action=" <?php echo base_url() . 'set_data/marking_type'; ?>" method="POST">
                ...
                <div class="form-group">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <label class="col-sm-3 control-label" for="addEnclosures">Add Question</label>
                        ...
                        <div class="row col-lg-8 form-group" id="enclosures_container">
                            <div class="enclo_row well" id="enclo_row" style="display: none;">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <input type="text" placeholder="Question Text/Name" class="form-control header_name">
                                    </div>
                                    <div class="col-lg-6">
