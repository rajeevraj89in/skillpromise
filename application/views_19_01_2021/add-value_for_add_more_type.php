...
<section class="col-md-9">
    ...
    <div class="dooble-border">
        ...
        <div class="panel">
            ...
            <h1 class=" header_text">Add Sheet Content:
       <?php 
...
<!--    <h1 class="page-header header-text">Add Sheet Content:
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action=" <?php echo base_url() . 'set/value_for_add_more_type'; ?>" method="POST">
