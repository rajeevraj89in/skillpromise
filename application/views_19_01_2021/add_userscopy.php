...
//                        echo '<input type="hidden" name="child_table" value = "user-node">';
//                        echo '<input type="hidden" name="foreign_id" value = "user">';
//                        foreach ($node_details as $key => $row){
//                        
//                            
//                       echo '<label class="radio-inline col-md-3">';
//                       echo '<input  type="checkbox" name="node['.($key + 1).']" id="Active" value="'.$row['id'].'">'.$row['name'];
//                       echo '</label>';
//                        }?>        
                    </div>
                </div>-->
                
<!--                <div class="row select_nodes hidden">
...
//	if($('#selectRole').val()=='2')
//	{
//          	$("#add_newrole").append('<fieldset style="margin-left:135px;"><legend>Add Permission</legend><table><tr><td>All Programs<input type="radio" name="permission" id="" value="" checked></td><td>Custom<input type="radio" name="permission" id=""></td></tr></table></fieldset><hr/>');
//	}
//    } 
...
//            initiateAjax('node', 'parent_id', getValue, ['id', 'parent_id', 'name', 'type', 'status', 'sort_order'], fillGrid, "content");
//        });
//    });
