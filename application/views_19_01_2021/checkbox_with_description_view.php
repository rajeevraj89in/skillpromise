            ...
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo base_url() . 'set_data/action_sheets'; ?>" method="POST">
                ...
                <table class="table table-bordered" id="">
                    ...
                    foreach ($data[$category['category']] as $rec) {
                        ...
                        . '<span style="display: inline-block; padding: 12px 10px; width: 91.4%; background: #01897b;  margin: 0px 0 0 10px; color: #fff;" class="tool" data-toggle="tooltip" data-name="'.$rec['name'].'" data-name="'.$rec['name'].'" title="Click me to know more" data-content="' .  htmlspecialchars($rec['tool_tip']) . '"> '
                        . $rec['name'] . '</span></td>';
