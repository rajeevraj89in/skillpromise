...
?>]);
        ...
        <div class = "row top-margin">
            <div class = "col-md-12 top-margin">
                <table width="100%">
                    <tr style="height:10;">
                        <td style="background-color:green;color:white;font-size:20px;"><strong><?php echo $name ?> Overall Score <?php echo $TOTAL_PERCENTAGE2 ?> %</strong></td>
                    </tr>
                </table>
                <br>
        ...
        <div class = "row">
            <div class = "col-md-12">
                <table width="100%">
                    <tr style="height:40;">
                        <td style="background-color:green;color:white;font-size:20px;"><strong><?php echo $name ?> Topic wise Analysis </strong></td>
                    </tr>
                </table>
                <br>
                <div class = "table-responsive">
