                ...
                <div class="row">
                    ...
                    <div class="col-md-12" id="exp_div" style="<?php echo ((isset($work_exp) && ($work_exp == '1')) ? "" : "display:none") ?>">
                        ...
                        <div class="row">
                            <hr>
                            <div class=" col-md-12">
                                <span class="help-block"><a href="#!" class="btn btn-xs btn-warning addMoreOrg" data-src="org_div">Add More Organisation</a></span>
                            </div>
                    ...
                    <!-- Show hide div-->
                    <div class="col-md-12" id="int_div" style="<?php echo ((isset($internship) && ($internship == '1')) ? "" : "display:none") ?>">
                        <div class="panel">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="">Name of the Organization</label>
                                <input type="text" class="form-control" name="int[org]" value="<?php echo ((!empty($int) ? $int['org'] : "")); ?>" id="" placeholder="">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="">Duration</label>
                                <input type="text" class="form-control" id="" name="int[duration]" value="<?php echo ((!empty($int) ? $int['duration'] : "")); ?>" placeholder="">
                            </div>
                            <!--set end-->
                            <!--set -->
                            <div class="form-group col-md-12">
                                <label for="">Designation</label>
                                <input type="text" class="form-control" id="" name="int[designation]" value="<?php echo ((!empty($int) ? $int['designation'] : "")); ?>" placeholder="">
                            </div>
                            <!--set end-->
                            <!--set -->
                            <div class="form-group col-md-12">
                                <label for="">Location</label>
                                <input type="text" class="form-control" name="int[loc]" id="" value="<?php echo ((!empty($int) ? $int['loc'] : "")); ?>" placeholder="">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="">Project Title</label>
                                <input type="text" class="form-control" name="int[project]" value="<?php echo ((!empty($int) ? $int['project'] : "")); ?>" id="" placeholder="Start with To. For Example: To Study/ To Identify/ To Design/ To Sell/ To Improvise/ To find/ To Support/ To Understand/ To Create etc.">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="">Brief Methodology</label>
                                <input type="text" class="form-control" id="" name="int[method]" value="<?php echo ((!empty($int) ? $int['method'] : "")); ?>" placeholder="Mention briefly about how you approached your internship. This section deals with the strategy behind your internship">
                            </div>
                            <!--set end-->
                            <!--set -->
                            ...
                            if (!empty($int['Responsibility'])) {
                                foreach ($int['Responsibility'] as $v) {
                                    echo '<div class="form-group col-md-12">';
                                    if ($c == 1)
                                        echo ' <label for="">Key Responsibilities (Suggested: Mention upto 5)</label>';
                                    echo ' <input type="text" class="form-control" name="int[res][]" id="" placeholder="" value="' . $v['data'] . '">';
                            ...
                            if ($c == 1) {
                                echo ' <div class="form-group col-md-12">
                                <label for="">Key Responsibilities (Suggested: Mention upto 5)</label>
                                <input type="text" class="form-control" name="int[res][]" id="" placeholder="">
                                <!--<span class="help-block"><a href="#!">Add More...</a></span>-->
                            </div>';
                            }
                            ?>
                            ...
                            if (!empty($int['Achievement'])) {
                                foreach ($int['Achievement'] as $v) {
                                    echo '<div class="form-group col-md-12">';
                                    if ($c == 1)
                                        echo '<label for="">Achievements (Suggested: Mention upto 5)</label>';
                                    echo ' <input type="text" class="form-control" name="int[ach][]" id="" placeholder="" value="' . $v['data'] . '">';
                            ...
                            if ($c == 1) {
                                echo '<div class="form-group col-md-12">
                                <label for="">Achievements (Suggested: Mention upto 5)</label>
                                <input type="text" class="form-control" name="int[ach][]" id="" placeholder="">
                                <!--<span class="help-block"><a href="#!">Add More...</a></span>-->
                            </div>';
                            }
                            ?>
                        ...
                        <div class="row">
                            ...
                            if (!empty($ach['pos_res'])) {
                                foreach ($ach['pos_res'] as $v) {
                                    ...
                                    echo ' <input type="text" class="form-control" name="hobbies_ach[pos_res][]" id="" placeholder="" value="' . $v['data'] . '">';
                            ...
                            if ($c == 1) {
                                ...
                                <input type="text" class="form-control" id="" name="hobbies_ach[pos_res][]" placeholder="">

                            </div>';
                            }
                            ?>
                            <div class="form-group col-md-12" id="hobbies_ach" style="display:none">
                                <input type="text" class="form-control" name="hobbies_ach[pos_res][]" id="" placeholder="">
                                <!--<span class="help-block"><a href="#!">Add More...</a></span>-->
                            </div>
                            <div class=" col-md-12">
					...
					<div class="col-md-12">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <span class="span" style="color:red; font-size:large;" id="img_error">Upto 300kb allowed</span>
                        </div>
                        <div class="col-md-12">
                            <br><br>
                            <button type="button" class="btn btn-success save_draft">Save as Draft</button>
