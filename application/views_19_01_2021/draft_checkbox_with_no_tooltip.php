<?php
//Created:Dewangshu , 24/08/2017 for edit/Save as Draft data of "Checkbox with no tooltip
            ...
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo base_url() . 'set_data/save_data_checkbox_with_no_tooltip'; ?>" method="POST">
                ...
                <table class="table table-bordered" id="">
                    ...
                    foreach ($data[$category['category']] as $rec) {
                        ...
                        //----
                        if ($ch) {
                            echo '<td width="33.33%" style="background: #fff; padding: 0 0px 0 9px; margin: 0; border: 4px solid #fff;"><input data-content="' . $rec['description'] . '" type="checkbox" class="check" checked data-category="' . $category['category'] . '" id="' . $rec['id'] . '" name="sheetvalue_id[' . $rec['id'] . ']" value="' . $prev_content . '">'
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <center>
                            <button type="submit" value="1" name="draft" class="btn btn-success">Save as Draft</button>&nbsp;<a href="<?php echo base_url('sheets_pdf/sheets/'.$sheet_id); ?>" class="btn btn-success">Dowload as PDF</a>
                        </center>
                    </div>
                    <div class="col-sm-3">
