                    ...
                    <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class='name checkEmpty' contenteditable="">
                                            <?php
                                            if ($ch) {
                                                echo '<input class="form-control" type="text" name="list[' . $i . '][key_value][4]" value="' . $prev_content[3] . '" />';
                                            } else {
                                                ?>
                    ...
                    <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class='name checkEmpty' contenteditable="">
                                            <?php
                                            if ($ch) {
                                                echo '<input class="form-control" type="text" name="list[' . $i . '][key_value][5]" value="' . $prev_content[4] . '" />';
                                            } else {
                                                ?>
