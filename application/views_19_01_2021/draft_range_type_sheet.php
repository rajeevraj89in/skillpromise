        ...
        <div class="col-md-12">
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo base_url() . 'set_data/save_data_range_type'; ?>" method="POST">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <center>
                            <button type="submit" value="1" name="draft" class="btn btn-success">Save as Draft</button>&nbsp;<a href="<?php echo base_url('sheets_pdf/sheets/'.$sheet_id); ?>" class="btn btn-success">Download as PDF</a>
                        </center>
