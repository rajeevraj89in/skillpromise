...
<section class="col-md-9">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="mainForm" enctype="multipart/form-data" class="form-horizontal" role="form" action=" <?php echo base_url() . 'set/dropdown_with_multi_addmore'; ?>" method="POST">
...
<!--                        <select class="form-control" id="category" name="category" required>
                            <?php // echo $category; ?>
                            <?php // echo $this->main_model->fill_select('dropdown_with_multi_addmore', 'category', $category); ?>
                        </select>-->
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" id="description" name="description" placeholder="Description"  value="<?php echo $description; ?>" required><?php echo $description; ?></textarea>
                    </div>
                </div>
