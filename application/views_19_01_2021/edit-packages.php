        ...
        <div class="col-md-12">
            <form enctype="multipart/form-data"  class="form-horizontal" autocomplete="off" role="form"  action="<?php echo base_url(); ?>set/packages" method="POST" onsubmit="return check()">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control editor" id="detailed_desc"  name="detailed_desc" placeholder="Description" value = "<?php echo $details['detailed_desc']; ?>"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="detailed_desc" class="col-sm-3 control-label">Learning Objectives</label>
                    <div class="col-sm-9">
                        <textarea class="form-control editor" id="learning_objectives"  name="learning_objectives" placeholder="Learning Objectives" value = "<?php echo $details['learning_objectives']; ?>"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="detailed_desc" class="col-sm-3 control-label">Program Benefits</label>
                    <div class="col-sm-9">
                        <textarea class="form-control editor" id="program_benefits"  name="program_benefits" placeholder="Program Benefits" value = "<?php echo $details['program_benefits']; ?>"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="detailed_desc" class="col-sm-3 control-label">Course Content</label>
                    <div class="col-sm-9">
                        <textarea class="form-control editor" id="course_content"  name="course_content" placeholder="Course Content" value = "<?php echo $details['course_content']; ?>"></textarea>
                    </div>
                </div>
                <!--                <div class="form-group">
                                    <label for="no_of_quiz" class="col-sm-3 control-label">No. of Quiz</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="no_of_quiz" name="no_of_quiz" placeholder="No. of Quiz" required>
                                    </div>
                                </div>-->
                ...
                <!--                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 input-group input-group-custom">
                                        <input type="text" class="form-control groupOfint" id="duration" name="duration" placeholder="Duration" value="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <p class="help-block"><img onchange="readURL(this);
                                src ="src="<?php echo (base_url() . 'assets/img/uploads/packages/no-image.jpg'); ?>" id="currrentImg" width="100" height="100" style="" alt="Current Image Show"></p>
