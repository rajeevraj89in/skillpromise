    ...
    <div class="col-lg-12 ">
        <footer class="fill_footer">
            <div class="footer">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <h4>Programs</h4>
                        <ul>
                            <li><a href="<?php echo(base_url() . "programedetails".'/'.'4'); ?>">Aptitude Development Program</a></li>
                    ...
                    <div class="col-md-2">
                        ...
                        <ul>
                            <?php
                            $records = $this->main_model->get_records("testimonials")->result_array();
                            foreach ($records as $key => $category) {
                                ?>
                                <li><a href="<?php echo(base_url() . "testimonials/" . $category['id']); ?>"><?php echo $category['name']; ?></a></li>
                                <?php
                            }
                            ?>
                        </ul>
                    ...
                    <!--div class="col-md-2">
                        <h4>Newsletter</h4>
                        <ul>
                            <li><a href="<?php echo base_url(); ?>news-letter">Subscribe</a></li>
                            <li><a>Archive</a></li>
            ...
            <div class="footer-bottom">
                <div class="row">
                    <div class="col-md-6"><p>© by Sana Skillpromise Education Private Limited. | All Rights Reserved. | Disclaimer</p></div>
