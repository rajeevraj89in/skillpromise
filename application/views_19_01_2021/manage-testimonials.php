...
<section class="col-md-9">
    ...
    <div class="row text-center">
        <div class="col-md-12">
            <a class="btn btn-primary" href="<?php echo base_url() . 'add/testimonials'; ?>">Add Testimonials</a>
        </div>
    </div><hr>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $rec) {
                            $tbl_str .= '<tr class="post">'
                                    . "<td>" . $count++ . "</td>"
                                    . "<td>" . $rec['name'] . "</td>"
                                    . "<td>" . $rec['detailed_desc'] . "</td>"
                                     . "<td><img style='height:200px;width:180px' src='".base_url()."assets/img/uploads/".$rec['image_file']."'> </td>"
                                    . "<td>" . $rec['status'] . "</td>"
                                    . '<td class="text-center"><a href=' . base_url() . "edit/testimonials/" . $rec['id'] . '><span class="glyphicon glyphicon-pencil"></span></a></td>'
                                    . '<td class="text-center"><a href="#" class="delete" data-url="' . base_url() . "delete/testimonials/" . $rec['id'] . '"><span class="glyphicon glyphicon-trash"></span></a></td>'
                                    . "</tr>";
                        }
                        echo $tbl_str;
                        ?>
