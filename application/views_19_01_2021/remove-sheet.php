...
<section class="col-md-9">
    <h1 class="page-header">All attempted sheet</h1>
                    ...
                    <tbody>
                        ...
                        foreach ($quiz_result as $rec) {
                            $tbl_str.='<tr class="post">'
                                    ...
                                    . '<td class="text-center"><a href=' . base_url() . "delete_sheet/sheet/" . $rec['id'] . '><span class="glyphicon glyphicon-trash"></span></a></td>'
                                    . "</tr>";
                        }
