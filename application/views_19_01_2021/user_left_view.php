                       ...
                       // echo "<pre>";
                        ...
                        //print_r($node_package);die;
                                foreach($node_package as $key => $value){
                                    if($value->id == 15 || $value->id == 2310 || $value->id == 2015 || $value->id == 2032 || $value->id == 1231 || $value->id == 2462 || $value->id == 3730 || $value->id == 3733 || $value->id == 3780 || $value->id == 2207){
                                        ?>
                                        <li>
						...
						if (!$child_node_id) {
							...
							//$this->custom->get_side_navigation_panel_new_student($parent_id, $nav_type); hide as on the 18/09/2020
